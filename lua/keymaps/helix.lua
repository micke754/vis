...
local normal = {
	...
	{ "<Space>F", "<vis-picker-files-current>", "Open current-directory file picker" },
	{ "<Space>b", "<vis-picker-buffers>", "Open buffer picker" },
	{ "<Space>j", "<vis-picker-jumplist>", "Open jumplist picker" },
	{ "<Space>g", "<vis-picker-changed>", "Open changed-file picker" },
	{ " f", "<vis-picker-files>", "Open file picker" },
	{ " F", "<vis-picker-files-current>", "Open current-directory file picker" },
	{ " b", "<vis-picker-buffers>", "Open buffer picker" },
	{ " j", "<vis-picker-jumplist>", "Open jumplist picker" },
	{ " g", "<vis-picker-changed>", "Open changed-file picker" },
